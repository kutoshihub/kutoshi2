...
UniValue dumpprivkey(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"kutoshiaddress\"\n"
            "\nReveals the private key corresponding to 'kutoshiaddress'.\n"
            "Then the importprivkey can be used with this output\n"
            "\nArguments:\n"
            "1. \"kutoshiaddress\"   (string, required) The kutoshi address for the private key\n"
            "\nResult:\n"
