...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s kutoshi-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  kutoshi-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded kutoshi transaction") + "\n" +
              "  kutoshi-tx [options] -create [commands]   " + _("Create hex-encoded kutoshi transaction") + "\n" +
              "\n";
