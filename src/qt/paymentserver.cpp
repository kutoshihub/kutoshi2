...
const QString BITCOIN_IPC_PREFIX("kutoshi:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/kutoshi-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/kutoshi-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/kutoshi-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click kutoshi: links
...
//
// OSX-specific way of handling kutoshi: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in kutoshi: URIs
