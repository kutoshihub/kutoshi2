 ...
 * between kutoshid, and kutoshi-qt and non-server tools.
*/
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/kutoshihub/Kutoshi>";
    const std::string URL_WEBSITE = "<https://kutoshi.org/>";
    ...
    return FormatParagraph(strprintf("Copyright (C) %i-%i The Bitcoin Core Developers", 2009, COPYRIGHT_YEAR)) + "\n" +
           ...
           "\n" +
           FormatParagraph(strprintf("Copyright (C) %i The Kutoshi Developers", 2024)) + "\n" +
           "\n" +
           FormatParagraph(strprintf(_("Please contribute if you find Kutoshi useful. "
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Kutoshi More version %s\n", FormatFullVersion());
}
