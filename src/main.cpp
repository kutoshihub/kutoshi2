...
#if defined(NDEBUG)
# error "Kutoshi cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Kutoshi Signed Message:\n";
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    // Kutoshi also requires DER encoding of pubkeys
    flags |= SCRIPT_VERIFY_DERKEY;
    // Kutoshi also requires low S in sigs
